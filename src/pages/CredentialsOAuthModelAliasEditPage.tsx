...
import styles from './CredentialsOAuthModelAliasEditPage.module.scss';
...
export function CredentialsOAuthModelAliasEditPage() {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      if (normalized.length) {
        await credentialsApi.saveOauthModelAlias(channel, normalized);
      } else {
        await credentialsApi.deleteOauthModelAlias(channel);
      }
