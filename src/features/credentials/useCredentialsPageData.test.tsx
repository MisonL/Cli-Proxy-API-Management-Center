...
import { useCredentialsPageData } from './useCredentialsPageData';
...
const files: CredentialItem[] = [
  { name: 'codex-a.json', type: 'codex', selectionKey: 'auth-a', modified: now - 1000 },
  {
    name: 'claude-b.json',
    type: 'claude',
    selectionKey: 'auth-b',
